...
export default function FloatingActionButton({ role }: Props) {
    ...
    // 1. Projects List -> New Project
    if (pathname === "/projects" && adminRole) {
        return (
            <Link href="/projects/new" className="fixed bottom-24 right-5 z-40 md:hidden w-14 h-14 bg-blue-600 hover:bg-blue-700 text-white rounded-full flex items-center justify-center shadow-lg shadow-blue-500/30 transition-transform active:scale-95 hover:scale-105">
